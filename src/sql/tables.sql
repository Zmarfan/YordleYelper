...
create table match_participant_challenges(
    ...
    danced_with_rift_herald bool not null,
    ...
    early_laning_phase_gold_exp_advantage bool not null,
    ...
    laning_phase_gold_exp_advantage bool not null,
    legendary_count int not null,
    lost_an_inhibitor bool not null,
    ...
    more_enemy_jungle_than_opponent bool not null,
    ...
    perfect_game bool not null,
    pick_kill_with_ally int not null,
    played_champ_select_position bool not null,
    poro_explosions int not null,
    quick_cleanse int not null,
    quick_first_turret bool not null,
    ...
    vision_score_advantage_lane_opponent bool not null,
